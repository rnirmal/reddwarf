...
bash ./run_cmd.sh sudo bash /vagrant/initialize.sh
if [ $? -ne 0 ]
then 
...
bash ./run_cmd.sh sudo bash /vagrant/build.sh
if [ $? -ne 0 ]
then 
...
bash ./run_cmd.sh sudo bash /vagrant-common/initialize_nova.sh
if [ $? -ne 0 ]
then 
...
bash ./run_cmd.sh sudo bash /vagrant/test.sh
if [ $? -ne 0 ]
then 
